...
class WandbLogPriorPosteriorSamplePlots(Callback):
    ...
    def _visualise_posterior_img(self, trainer, pl_module):
        ...
        imgs = []
        if channels == 3: # celeb
            list_n_context = [round(32*32*0.01), round(32*32*0.10), round(32*32*0.25), round(32*32*0.50), 32*32]
        else: # mnist
            list_n_context = [round(28*28*0.01), round(28*28*0.10), round(28*28*0.25), round(28*28*0.50), 28*28]
